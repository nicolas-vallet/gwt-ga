...
public interface GoogleAnalytics
{
   ...
   *                 object.
   */
  void trackEvent( String trackerName, String category, String action );
   ...
   * @param action   A string that is uniquely paired with each category, and commonly
   *                 used to define the type of user interaction for the web object.
   * @param optLabel An string to provide additional dimensions to the event data.
   * @param optValue An integer that you can use to provide numerical data about the user event.
   */
